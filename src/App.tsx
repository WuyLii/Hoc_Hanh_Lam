...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F9F7F2] text-[#1A1A1A] font-sans selection:bg-[#1A1A1A] selection:text-[#F9F7F2] flex flex-col overflow-x-hidden w-full max-w-full">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-3 sm:px-6 lg:px-8 py-3.5 sm:py-8 pb-[calc(5.2rem+env(safe-area-inset-bottom))] md:pb-8 overflow-x-hidden">
      ...
      <footer className="border-t border-[#1A1A1A] bg-[#F3EFE6] py-6 text-[#1A1A1A] mb-[calc(4.5rem+env(safe-area-inset-bottom))] md:mb-0">
